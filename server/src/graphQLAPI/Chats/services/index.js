...
// console.log("GOIN FOR GOLD!");
// const sender = await getUserById(senderId);
// const recipient = await getUserByUuid(input.recipientUuid);
// console.log("SENDER! ", sender);
// console.log("RECIPIENT! ", recipient);

const createGroupChat = async (userId, input) => {
  let createdChat;
  if (userId && input) {
    input.creator = userId;
    createdChat = await createChat(input);
  } else {
